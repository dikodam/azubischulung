...
public class CrossedWires {
    ...
    public static void main(String[] args) {
        // TODO input parsen:
        // input splitten in wire1String und wire2String
        String[] inputStrings = input.split("\n");
        // aus jedem wireString die Commands auslesen (oder: verwandeln in List<Command>)
        ...
        // die Mahattan-Distance der Schnittpunkte bestimmen
        // die kleinste Manhattan-Distance ausgeben/printen
    ...
    public static List<Command> parseLine(String line) {
        ...
        for (String command : commandStrings) {
            // aus dem command-String richtung auslesen -> erster buchstabe
            char directionChar = command.charAt(0);
            // directionChar verwandeln in das enum Direction
            Direction direction = Direction.from(directionChar);
            // schrittweite auslesen -> alles nach der ersten stelle
            String steps = command.substring(1);
            Command myCommand = new Command(direction, Integer.parseInt(steps));
            // in eine liste werfen
